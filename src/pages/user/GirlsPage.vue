<template>
    <div id="itemsSection" class="mx-auto w-full 2xl:container bg-white pb-8 px-4">
        ...
        <BannerComponent />
        <div id="itemsSection" class="grid md:grid-cols-12 grid-cols-1 gap-6">
            <div class="lg:col-span-3 md:col-span-4">
                <!-- filters and sorting block for mobile -->
                <div class="md:hidden bg-white w-full fixed bottom-0 left-0 z-[999]">
                    <div class="flex">
                        <button type="button" class="text-base w-full font-medium p-3 border-t"
                                    ...
                                    <ul class="list-none mt-2 max-h-52 pl-2 overflow-auto">
                                        <li class="ms-0" v-for="(x, index) of brandsData?.brands" :key="x.id">
                                            <div class="flex h-6 items-center group/check">
                                                <input :id="`brand-check-${index}`" :name="`brand-check-${index}`"
                                                    type="checkbox" @change="FilterBrand(x)" :value="x.id"
                                                    :checked="checkedBrand.includes(x.id)"
                            ...
                            <details class="group">
                                ...
                                <div class="text-neutral-600 my-3 group-open:animate-fadeIn">
                                    <ul class="list-none mt-2 max-h-52 pl-2 overflow-auto">
                                        <li class="ms-0">
                                            <div class="flex h-6 items-center group/check">
                                                <input :id="`age-check-0`" :name="`age-check-0`" type="checkbox"
                                                    @change="FilterCombination()" :value="0" v-model="checkedAge"
                                                    class="h-4 w-4 rounded border-gray-300 text-gray-700 group-hover/check:border-gray-500 focus:ring-gray-600">
                                        ...
                                        <li class="ms-0">
                                            <div class="flex h-6 items-center group/check">
                                                <input :id="`age-check-2`" :name="`age-check-2`" type="checkbox"
                                                    @change="FilterCombination()" :value="1" v-model="checkedAge"
                                                    class="h-4 w-4 rounded border-gray-300 text-gray-700 group-hover/check:border-gray-500 focus:ring-gray-600">
                                        ...
                                        <li class="ms-0">
                                            <div class="flex h-6 items-center group/check">
                                                <input :id="`age-check-4`" :name="`age-check-4`" type="checkbox"
                                                    @change="FilterCombination()" :value="2" v-model="checkedAge"
                                                    class="h-4 w-4 rounded border-gray-300 text-gray-700 group-hover/check:border-gray-500 focus:ring-gray-600">
                                        ...
                                        <li class="ms-0">
                                            <div class="flex h-6 items-center group/check">
                                                <input :id="`age-check-6`" :name="`age-check-6`" type="checkbox"
                                                    @change="FilterCombination()" :value="3" v-model="checkedAge"
                                                    class="h-4 w-4 rounded border-gray-300 text-gray-700 group-hover/check:border-gray-500 focus:ring-gray-600">
                                        ...
                                        <li class="ms-0">
                                            <div class="flex h-6 items-center group/check">
                                                <input :id="`age-check-8`" :name="`age-check-8`" type="checkbox"
                                                    @change="FilterCombination()" :value="4" v-model="checkedAge"
                                                    class="h-4 w-4 rounded border-gray-300 text-gray-700 group-hover/check:border-gray-500 focus:ring-gray-600">
                            ...
                            <details class="group">
                                ...
                                <div class="text-neutral-600 my-3 group-open:animate-fadeIn">
                                    <ul class="list-none mt-2 max-h-52 pl-2 overflow-auto">
                                        ...
                                        <li class="ms-0">
                                            <div class="flex h-6 items-center group/check">
                                                <input :id="`price-check-1000`" :name="`price-check-1000`"
                                                    type="checkbox" @change="FilterCombination()" :value="'1000'"
  ...
  <input id="default-range" type="range" value="50" class="w-full h-2 bg-gray-200 rounded-lg appearance-none cursor-pointer dark:bg-gray-700"> -->
                                    ...
                                    <ul class="list-none mt-2 max-h-52 pl-2 overflow-auto">
                                        <li class="ms-0">
                                            <div class="flex h-6 items-center group/check">
                                                <input :id="`price-check-1000`" :name="`price-check-1000`"
                                                    type="checkbox" @change="FilterCombination()" :value="'20'"
                                        ...
                                        <li class="ms-0">
                                            <div class="flex h-6 items-center group/check">
                                                <input :id="`price-check-1000`" :name="`price-check-1000`"
                                                    type="checkbox" @change="FilterCombination()" :value="'30'"
                                                    v-model="checkedDiscount"
                                                    class="h-4 w-4 rounded border-gray-300 text-gray-700 group-hover/check:border-gray-500 focus:ring-gray-600">
                                        ...
                                        <li class="ms-0">
                                            <div class="flex h-6 items-center group/check">
                                                <input :id="`price-check-1000`" :name="`price-check-1000`"
                                                    type="checkbox" @change="FilterCombination()" :value="'40'"
                                                    v-model="checkedDiscount"
                                                    class="h-4 w-4 rounded border-gray-300 text-gray-700 group-hover/check:border-gray-500 focus:ring-gray-600">
                                        ...
                                        <li class="ms-0">
                                            <div class="flex h-6 items-center group/check">
                                                <input :id="`price-check-1000`" :name="`price-check-1000`"
                                                    type="checkbox" @change="FilterCombination()" :value="'50'"
                                                    v-model="checkedDiscount"
                                                    class="h-4 w-4 rounded border-gray-300 text-gray-700 group-hover/check:border-gray-500 focus:ring-gray-600">
                                        ...
                                        <li class="ms-0">
                                            <div class="flex h-6 items-center group/check">
                                                <input :id="`price-check-1000`" :name="`price-check-1000`"
                                                    type="checkbox" @change="FilterCombination()" :value="'60'"
                                                    v-model="checkedDiscount"
                                                    class="h-4 w-4 rounded border-gray-300 text-gray-700 group-hover/check:border-gray-500 focus:ring-gray-600">
            ...
            <div class="lg:col-span-9 md:col-span-8">
                <section v-if="filterDataUpdate && !isMobile" class="relative">
                    ...
                    <div v-if="updatedItemsFiltersData.length > 0">
                        <div class="grid xl:grid-cols-4 lg:grid-cols-3 grid-cols-2 gap-6 pt-3">
                            <ItemComponent v-for="x of updatedItemsFiltersData" :key="x" :item="x" :brand="x.brand">
                            </ItemComponent>
                        </div>
                        <div class="center">
                ...
                <section v-else-if="filterDataUpdate && isMobile" class="relative">
                    ...
                    <div v-if="updatedItemsMobileFiltersData.length > 0">
                        <div class="grid xl:grid-cols-4 lg:grid-cols-3 grid-cols-2 gap-6 pt-3">
                            <ItemComponent v-for="x of updatedItemsMobileFiltersData" :key="x" :item="x"
                                :brand="x.brand">
                            </ItemComponent>
                        </div>
                ...
                <section v-else-if="categoryIdUpdated && !isMobile" class="relative">
                    <div class="md:flex justify-between items-center mb-3">
                        <span class="font-semibold">Showing {{ updatedItemsByCategoryData.length }}
                            items</span>
                        <div v-if="updatedItemsByCategoryData.length != 0" class="md:flex items-center"
                            :class="[mobSorting ? 'flex' : 'hidden', isMobile ? 'bg-white fixed bottom-0 left-0 w-full z-[998] pt-4 px-4 border-t' : 'flex', isMobile ? (!mobile_app_info ? 'pb-[120px]' : 'pb-[66px]') : 'pb-0']">
                            <label class="font-semibold md:me-2" :class="[mobSorting ? 'hidden' : '']">Sort by:</label>
                            <select v-model="shortItem"
                                class="form-select form-input text-sm md:w-48 w-full md:mt-0 mt-1 py-2 px-3 h-10 bg-transparent rounded outline-none border border-gray-200 focus:ring-0">
                    ...
                    <div v-if="updatedItemsByCategoryData.length > 0">
                        <div class="grid xl:grid-cols-4 lg:grid-cols-3 grid-cols-2 gap-6 pt-3">
                            <ItemComponent v-for="x of updatedItemsByCategoryData" :key="x" :item="x" :brand="x.brand">
                            </ItemComponent>
                        </div>
                        <div class="center">
                            <div class="flex flex-wrap my-6 justify-end">
                ...
                <section v-else-if="categoryIdUpdated && isMobile" class="relative">
                    <div class="md:flex justify-between items-center mb-3">
                        <span class="font-semibold">Showing {{ updatedItemsByMobileCategoryData.length }}
                            items</span>
                        <div v-if="updatedItemsByMobileCategoryData.length != 0" class="md:flex items-center"
                            :class="[mobSorting ? 'flex' : 'hidden', isMobile ? 'bg-white fixed bottom-0 left-0 w-full z-[998] pt-4 px-4 border-t' : 'flex', isMobile ? (!mobile_app_info ? 'pb-[120px]' : 'pb-[66px]') : 'pb-0']">
                            <label class="font-semibold md:me-2" :class="[mobSorting ? 'hidden' : '']">Sort by:</label>
                            <select v-model="shortMobileItem"
                                class="form-select form-input text-sm md:w-48 w-full md:mt-0 mt-1 py-2 px-3 h-10 bg-transparent rounded outline-none border border-gray-200 focus:ring-0">
                    ...
                    <div v-if="updatedItemsByMobileCategoryData.length > 0">
                        <div class="grid xl:grid-cols-4 lg:grid-cols-3 grid-cols-2 gap-6 pt-3">
                            <ItemComponent v-for="x of updatedItemsByMobileCategoryData" :key="x" :item="x"
                                :brand="x.brand">
                            </ItemComponent>
                        </div>
                        <div v-if="visiblePages.length > pageNo + 1" class="mt-6 flex justify-center">
...
const product = computed(() => {
    return {
        name: route?.params.id !== undefined ? `${itemsByCategory.value?.itemsByCategoryId[0]?.category.name}` : 'Best Offers',
        subname: '',
        href: route?.fullPath,
        breadcrumbs: [
            { id: 1, name: 'Home', href: '#' },
...
const { result: itemsByCount, refetch: refetchItemsByCount } = useQuery(
    computed(() => {
      ...
      query  GetItemsByPageCount{
        itemsByPageCount(id: "${categoryId.value}", amount: "${itemAmount.value}", less1: ${less1.value}, less6: ${less6.value}, greater6: ${great6.value} categorytypeid: "${categoryTypeId.value}",  name: "category")
      }
     `
    })
)
...
const updatedItemsFiltersData = computed(() => {
    ...
    switch (shortItem.value) {
        case "Price: Low-High":
            itemFilterAgeData.sort((a, b) => a.amount - b.amount);
            break;
        case "Price: High-Low":
            itemFilterAgeData.sort((a, b) => b.amount - a.amount);
            break;
        default:
...
const updatedItemsByMobileCategoryData = computed(() => {
