<template>
    ...
    <div class="mx-auto max-w-2xl text-center">
      ...
      <p class="mt-2 text-lg leading-8 text-gray-600">To make queries with our Preline office, please complete the form. Otherwise, we welcome you to contact our scheduling coordinator directly during our normal office hours</p>
    </div>
    <form action="#" method="POST" class="mx-auto mt-16 max-w-xl sm:mt-20">
      <div class="grid grid-cols-1 gap-x-8 gap-y-6 sm:grid-cols-2">
        ...
        <div class="sm:col-span-2">
          ...
          <div class="relative mt-2.5">
            ...
            <input v-model="phone" type="tel" name="phone-number" id="phone-number" autocomplete="tel"
      ...
      <div class="mt-10">
        <button @click="submitMessage()"
          class="mt-6 w-full rounded-md bg-yellow-300 py-2 font-bold text-yellow-900 shadow hover:shadow-lg hover:bg-yellow-200 transition duration-200 ease-out">Let's
          talk</button>
      </div>
    </form>
  </div>
