      ...
      <q-drawer side="right" v-model="leftDrawerOpen" bordered :width="300">
        ...
        <div class="q-ma-md">
          <q-form class="q-gutter-md" @submit.prevent="onSubmit">
            <q-input filled v-model="name" label="Title*"></q-input>
            <!-- <q-input filled v-model="description" label="Description*" ></q-input> -->
            <q-input filled v-model="amount" label="Amount*"></q-input>
            <div class="q-my-md">
...
export default defineComponent({
  ...
  setup() {
    ...
    return { leftDrawerOpen, name, description, amount, filter, handleClick, onSubmit };
  },
});
</script>
